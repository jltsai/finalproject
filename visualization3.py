...
fig, ax = plt.subplots()
ax.scatter(recommended_songs, percent_change1, c = 'red', label="Valence | Negative Sentiment")
ax.scatter(recommended_songs, percent_change2, c = 'blue', label="Energy | Bored Emotion")
ax.legend()
ax.set_xlabel('Recommended Song from Spotify')
ax.set_ylabel('% Change')
ax.set_title('Valence | Negative Sentiment vs Energy | Bored Emotion')
ax.grid(True)
